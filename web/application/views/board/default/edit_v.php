...
<div class="right_content">
	...
	<h2><?php echo  MENU_BOARD_NAME ?> 게시글 수정</h2>
...
<tr>
	<td width="80">글 제목</td>
	<td><input type="text" value="<?php echo $views['subject']?>" size="50" name="subject" />
	</td>
</tr>
<tr>
	<td>글 내용</td>
...
<tr>
	<td>Tag</td>
	<td><input type="text" value="<?php echo $tags?>" size="50" name="tags" /> (예 : 제목, 한국, 홍수)</td>
</tr>
<!--tr>
	<td>파일첨부</td>
