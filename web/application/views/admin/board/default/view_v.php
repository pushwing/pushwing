...
$(document).ready(function () {
	$.viewer.init('#view_contents', {overlay_disable_container: '#board_view', overlay_opacity: 0.1, overlay_color: '#fff'});
});
...
<table id="rounded-corner">
    <thead>
        <tr>
            ...
            <th scope="col" class="rounded-q4" align="right">답글 <span class="view_num"><?php echo number_format($views['reply_count'])?></span> 코멘트 <span class="view_num"><?php echo number_format($views['comment_count'])?></span> 조회수 <span class="view_num"><?php echo number_format($views['hit'])?></span> 추천 <span class="view_num" id="recommend_count"><?php echo number_format($views['voted_count'])?></span>
     비추 <span class="view_num" id="blamed_count"><?php echo number_format($views['blamed_count'])?></span>
    Date <span class="date"><?php echo  $views['reg_date']?></span> <span class="ip"><?php echo ($this->session->userdata('auth_code') >= '15')?$views['ip']:''?></span>
            </th>
        </tr>
    </thead>
    <tfoot>
...
<div class="board_button">
	...
	<div style="float:right;" id="gBtn7">
        <a class="bt_green" href="/<?php echo $this->seg_exp[0]?>/lists/0/page/<?php echo $page_account?>"><span class="bt_green_lft"></span><strong>목록</strong><span class="bt_green_r"></span></a
		
<?php  
    if ($this->tank_auth->get_user_id() == $views['user_id']) 
    { 
?>
		<a href="/<?php echo  $this->seg_exp[0] ?>/edit/<?php echo $views['id']?>/page/<?php echo $page_account?>" id="btn_list"><span>&nbsp;&nbsp;수정&nbsp;&nbsp;</span></a>
<?php 
    } 
	...
	{ 
?>
        <a href="/<?php echo $this->seg_exp[0] ?>/delete/<?php echo $views['id']?>/page/<?php echo $page_account?>" id="btn_list"><span>&nbsp;&nbsp;삭제&nbsp;&nbsp;</span></a>
<?php 
    }
...
<?php 
        ...
        { 
?>
        <a href="/<?php echo $this->seg_exp[0] ?>/write/<?php echo $views['board_pid'];?>" id="btn_list" ><span>&nbsp;&nbsp;답글쓰기&nbsp;&nbsp;</span></a>
<?php 
        }
