...
<table id="rounded-corner">
    <thead>
        <tr>
    	    ...
    	    <th scope="col" class="rounded">조회</th>
    		<th scope="col" class="rounded-q4">추천수</th>
    	</tr>
    <tfoot>
        <tr>
            <td colspan="5" class="rounded-foot-left"><em>table footer</em></td>
...
?>
 	<tr>
    	<td><?php if($reply_check != $lt['board_pid']) { echo $lt['board_pid'];  } else { echo "-"; }?></td>
     	<td>
		<a href="/<?php echo  $this->seg_exp[0] ?>/view/<?php echo  $this->seg_exp[2] ?>/<?php echo  $lt['id'] ?>/page/<?php echo $page_account?>/<?php echo $search_url?><?php echo $search_sfl?>" title="<?php echo  $bubble_title ?>"><?php echo  $bl1 ?><?php echo  strcut_utf8(strip_tags($lt['subject']), 30) ?><?php echo  $bl2 ?></a> [<?php echo $lt['comment_count']?>]</a>
		</td>
...
?>
    ...
    <a class="bt_green" href="/<?php echo  $this->seg_exp[0] ?>/write/0"><span class="bt_green_lft"></span><strong>글쓰기</strong><span class="bt_green_r"></span></a>
    <br />
        <!-- 페이지 -->
