		...
		<tr>
			...
			<td>
				<select name="scope">
					...
					<option value="c" <?php echo $condition['scope'] == 'c' ? 'selected' : '';?>>회사명</option>
					<option value="b" <?php echo $condition['scope'] == 'b' ? 'selected' : '';?>>담당자명</option>
				</select>
	...
	<table id="rounded-corner">
		<thead>
			<tr>
				...
				<th scope="col" class="rounded" align="center">회사명</th>
				<th scope="col" class="rounded" align="center">담당자명</th>
				<th scope="col" class="rounded" align="center">전화번호</th>
				<th scope="col" class="rounded-q4" align="center">등록일</th>
			</tr>
		</thead>
		<tbody>
<?php
...
?>
			<tr>
				...
				<td align="center"><a href="/admin/client/detail/0/<?php echo $row['id'];?>"><?php echo $row['name'];
                        ?></a></td>
				<td align="center"><?php echo $row['charge_person_name'];?></td>
				<td align="center"><?php echo $row['charge_phone'];?></td>
