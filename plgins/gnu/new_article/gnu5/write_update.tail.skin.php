...
* 작성일 2014.2.27
* 수정일 2014.3.12
* - 운영자가 글을 작성할 때는 푸시가 발송되지 않도록 수정
* 수정일 2014.04.03
* - url 관련 버그 수정
*/
...
//파트너 등록 비용은 무료입니다.
$psw_client_id = "PUSHWING_CLIENT_ID";     // 당신의 클라이언트 아이디
$psw_mysql_id = "PUSHWING_MYSQL_ID";       // 당신의 푸시윙 mysql id
$psw_mysql_pw = "PUSHWING_MYSQL_PASSWORD"; // 당신의 푸시윙 mysql password
...
$psw_callback_url = G5_HTTP_BBS_URL.'/board.php?bo_table='.$bo_table.'&wr_id='.$wr_id.$qstr;
